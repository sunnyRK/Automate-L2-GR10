...
interface TestAaveFlashLoanInterface extends ethers.utils.Interface {
  functions: {
    "ADDRESSES_PROVIDER()": FunctionFragment;
    "LENDING_POOL()": FunctionFragment;
    "executeOperation(address[],uint256[],uint256[],address,bytes)": FunctionFragment;
    "testFlashLoan(address,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFlashLoan",
...
export class TestAaveFlashLoan extends Contract {
  ...
  interface: TestAaveFlashLoanInterface;
