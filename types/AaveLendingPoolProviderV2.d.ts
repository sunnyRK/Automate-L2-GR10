...
interface AaveLendingPoolProviderV2Interface extends ethers.utils.Interface {
  functions: {
...
export class AaveLendingPoolProviderV2 extends Contract {
  ...
  interface: AaveLendingPoolProviderV2Interface;
